...
**Is CCTools official?**
CCTools is not an official Canton Network or Digital Asset product. However, we are an independent platform built for the Canton ecosystem, we are part of the Canton ecosystem, and we have received an approved Canton Dev Fund grant.
...
Yes! You can connect Canton wallets along with cross-chain wallets from EVM and SVM networks to track a unified portfolio. Head to **Portfolio** or **Profile > Connections** to link all your wallets in one place.
